...
{
    public class NewebpayTradeInfo: BasicInfo
    {
        /// <summary>
        /// * 商店代號
        /// </summary>
        ...
        /// <para>2.若為空值，交易完成後，消費者將停留在藍新金流付款或取號完成頁面。</para>
        ...
        /// <para>2.此參數若為空值，則會顯示取號結果在藍新金流頁面。</para>
        /// </summary>
        ...
        /// <summary>
        /// * 藍新金流會員
        /// <para>0=不須登入藍新金流會員</para>
        /// <para>1=須要登入藍新金流會員</para>
        /// </summary>
        ...
        /// <summary>
        /// 物流啟用
        /// <para>1.使用前，須先登入藍新金流會員專區啟用物流並設定退貨門市與取貨人相關資訊。
